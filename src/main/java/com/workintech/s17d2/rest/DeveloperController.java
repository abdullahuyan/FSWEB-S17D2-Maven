...
public class DeveloperController {
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(createdDeveloper,HttpStatus.CREATED.value(), "created");
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if(foundDeveloper==null){
            return new DeveloperResponse(null, HttpStatus.NOT_FOUND.value(), "kayıt bulunamadı id:" +id);
        }
        return new DeveloperResponse(foundDeveloper,HttpStatus.OK.value(), "kayıt bulundu");
    }
    ...
    public DeveloperResponse update(@PathVariable("id") int id,@RequestBody Developer developer){
        ...
        return new DeveloperResponse(newDeveloper,HttpStatus.OK.value(), "güncellendi");
    }
    ...
    public  DeveloperResponse delete(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(removedDeveloper,HttpStatus.NO_CONTENT.value(), "silindi");
    }
}
